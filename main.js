...
var author$project$Main$init = {
	now: _Utils_Tuple2(elm$time$Time$Oct, 2018),
	selected: _Utils_Tuple2(elm$time$Time$Mar, 2018),
	viewYear: 2018
};
...
var author$project$Mdc$MonthPicker$months = function (year) {
	return _List_fromArray(
		[
			...
			_Utils_Tuple2(elm$time$Time$Feb, year),
			_Utils_Tuple2(elm$time$Time$Mar, year),
			_Utils_Tuple2(elm$time$Time$Apr, year),
			_Utils_Tuple2(elm$time$Time$May, year),
			_Utils_Tuple2(elm$time$Time$Jun, year),
			_Utils_Tuple2(elm$time$Time$Jul, year),
			_Utils_Tuple2(elm$time$Time$Aug, year),
			_Utils_Tuple2(elm$time$Time$Sep, year),
			_Utils_Tuple2(elm$time$Time$Oct, year),
			_Utils_Tuple2(elm$time$Time$Nov, year),
...
var author$project$Mdc$MonthPicker$view = F4(
	function (msgs, now, selected, viewYear) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$id('month-picker')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('material-icons chevron'),
											elm$html$Html$Events$onClick(msgs.prev)
										]),
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											elm$html$Html$text(
											elm$core$String$fromInt(viewYear))
										])),
									A2(
									elm$html$Html$i,
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('material-icons chevron'),
											elm$html$Html$Events$onClick(msgs.next)
										]),
									_List_fromArray(
										[
